public class CafeJava {
    public static void main(String[] args) {
        ...
        if (isReadyOrder4) {
            ...
            System.out.println(displayTotalMessage + cappucinoPrice); // Displays "Your total is $2.5"
        }
        else {
            System.out.println(customer4 + pendingMessage); // Displays "Noah, your order will be ready shortly"
        }

        System.out.println(displayTotalMessage + (lattePrice + lattePrice)); // Displays Your total is $7"
        if (isReadyOrder2) {
        ...
        System.out.println(customer3 + displayTotalMessage + (lattePrice - dripCoffeePrice)); // Displays "Jimmy, your total is $.50"
    }
}
